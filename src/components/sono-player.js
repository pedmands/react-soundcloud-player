...
const sonoUrl = 'https://soundcloud.com/markhphillips/sets/new-album-quick-mastering/s-kyNma';
...
class CustomPlayer extends React.Component {
    ...
    renderTrackList() {
      ...
      return (
          <ol className="playlist">{tracks}</ol>
      );
    }// renderTrackList
    handleClick(){
        this.setState( { condition : !this.state.condition } );
...
export default class SonoPlayer extends Component {

  render() {
    return (
        <SoundPlayerContainer resolveUrl={sonoUrl} clientId={clientId} {...this.props}>
            <CustomPlayer />
